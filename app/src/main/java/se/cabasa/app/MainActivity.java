...
*/
    ...
    private void updateTableView() {
        currentLap++;
        mStopwatchFragment.addLap(new Laps(currentLap, "Lapnumber:" + currentLap, "Laptime: " + timeForStopwatch));
    ...
    public static class stopWatchFragment extends Fragment {
        public List<Laps> mLapnumber;
        public LapListAdapter mLapAdapter;

        public stopWatchFragment() {
            mLapnumber = new LinkedList<Laps>();
    ...
    public static class LapListAdapter extends BaseAdapter {
        ...
        public LapListAdapter(Activity mActivity, List<Laps> mLapnumber) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(mActivity, R.layout.laps_item, null);
            }

            Laps laps = mLapnumber.get(position);
